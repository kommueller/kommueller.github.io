...
(35) Ludwig, K., Müller, P., Nikolajevic, N., & Grote, A. (accepted). Putting 'filter bubble' effects to the test: Evidence on the polarizing impact of ideology-based news recommendation from two experiments in Germany and the U.S. *Information, Communication and Society*.
